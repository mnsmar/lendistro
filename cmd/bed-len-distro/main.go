...
const descr = "Measure the length distribution of the records in BED file/s. " +
	cmd.OutDescription
...
func (Opts) Version() string { return "bed-len-distro 0.1" }

// Description returns an extended description of the program.
func (Opts) Description() string { return descr }

// reader encapsulates a bed.Reader and satisfies lendistro.Reader.
type reader struct{ r *bed.Reader }
